...
signupForm.addEventListener("submit", async (e) => {
    ...
    try {
        ...
        // signup successful, save user to local storage (without password) and redirect
        const userToSave = {
            Id: addedUser.Id,
            Name: addedUser.Name,
        ...
        saveToLocalStorage("currentUser", userToSave);
        ...
        setTimeout(() => {
            if (userToSave.Role === "Admin" || userToSave.Role === "Seller") {
